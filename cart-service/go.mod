...
require (
	...
	github.com/wazwki/WearStore/product-service v0.0.0-20250105005234-f5e664be8b1e
	github.com/wazwki/WearStore/user-service v0.0.0-20250105005234-f5e664be8b1e
